<template>
  <div class="main-home-page">
    ...
    <ScrollableRow title="热门推荐" :items="hotsItems" />
    <!-- 测试数据 -->
    <ScrollableRow title="猜你喜欢" :items="likeItems"  />
    <ScrollableRow title="歌手推荐" :items="singersItems"/>
    <ScrollableRow title="历史播放" :items="historyItems"/>
  </div>
</template>
