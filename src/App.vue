  ...
  <div class="common-layout">
    <el-container>
      ...
      <el-footer style="
              ...
              min-width:859px
            ">
        <BottonBar @queue-change="updateQueue" @music-change="updateCurrentMusic"
          @progress-change="updateCurrentTime" />
      </el-footer>
    </el-container>
    <!-- 后台管理弹窗 -->
    <el-dialog style="min-height: 800px;" v-model="adminDialog" title="后台管理" width="80%" align-center>
      <AdminMain />
    </el-dialog>
  </div>
